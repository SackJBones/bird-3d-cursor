...
- [ ] Execute the hand-data feasibility probe under ClientSim and validate runtime missing-bone/scale behavior. Prove two-hand cursor/click behavior with real hardware before making a polished world. Provide a clearly labeled controller/desktop fallback where true joint input is unavailable.
