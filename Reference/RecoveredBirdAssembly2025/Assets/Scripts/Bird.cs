...
public class Bird : MonoBehaviour {
    ...
    public bool down;
    public bool up;
    public Material birdSelectedMaterial, birdMaterial; // ok if null. null = no material change on select/deselect
    ...
    void Update() {
        ...
        range = (birdPosition - handRoot).magnitude;//figure out how far away bird is along birdRay
    ...
    void ChangeMaterial(GameObject parent, Material newMat)
    {
        Renderer[] children;
        children = parent.GetComponentsInChildren<Renderer>(); // note: includes parent. will set parent material too.
