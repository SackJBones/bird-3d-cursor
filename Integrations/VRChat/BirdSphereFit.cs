...
public class BirdSphereFit : UdonSharpBehaviour
{
    ...
    // Continuous conditioning estimate for optional downstream limit laws.
    [HideInInspector] public float confidence;
    ...
    public void Fit()
    {
        ...
        confidence = Smooth((determinant - 0.000001f) / 0.00001f);
