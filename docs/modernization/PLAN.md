...
The Desktop Preview sample now passes 73 Play Mode/render checks in Unity 2020.3.33f1 with Direct3D 11. Three 16:9 camera captures were inspected, and framing was tightened. This includes the earlier 58 behavior/cleanup checks. The captures exclude IMGUI; GUI input/layout and other render targets remain unverified. See tests/README.md for `-Package -Preview -PlayMode -RenderPreview`. The preview now has a bounded fading trail per cursor (128 points, 2.5 seconds) and passes 94 Play Mode/render checks, including trail behavior and cleanup. Next prioritize optional adapter assembly separation or user-facing interaction work; trail profiling, multiplayer and mandala features remain unfinished.
