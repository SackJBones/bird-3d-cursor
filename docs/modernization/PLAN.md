...
- [ ] Deploy and launch the Unity 2022 smoke APK after the renewed USB-debugging authorization; inspect XR startup logs and keep physical visual checks separate.
