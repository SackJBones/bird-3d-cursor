...
These are camera RenderTexture captures, not screenshots of the Unity editor or Game view. They exclude IMGUI controls and do not validate GUI input/layout, animated poses across their entire range, other aspect ratios, render pipelines, or standalone shader stripping. Inspect the PNGs separately for framing and appearance. The 73-check run passes on Unity 2020.3.33f1 with Direct3D 11 locally.
